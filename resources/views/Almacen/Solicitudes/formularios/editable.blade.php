    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <span class="form-control custom-span">{{$solicitud->Vale->Solicitante->nombre}} {{$solicitud->Vale->Solicitante->apellido_paterno}} {{$solicitud->Vale->Solicitante->apellido_materno}}</span>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <input type="date" name="fechasalida" id="fechaentrada" class="form-control custom-input"
                    value="{{ isset($solicitud) ? $solicitud->Vale->fechaentrada : old('fechaentrada') }}" required>
            </div>
        </div>
    </div>
    <br>
